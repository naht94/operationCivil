...
(
    `resident_serial_number`       integer(11)  not null,
...
(
    ...
    `report_resident_serial_number`    integer(11) not null,
...
(
    `base_resident_serial_number`   integer(11) not null,
    `family_resident_serial_number` integer(11) not null,
...
(
    `household_serial_number`           integer(11)  not null,
    `household_resident_serial_number`  integer(11)  not null,
...
(
    `certificate_confirmation_number` bigint auto_increment not null,
    `resident_serial_number`          integer(11)           not null,
...
insert into resident values(123, '하지연', '500315-1234568', '여', '2018-03-15 11:22:00', '병원', '경기도 수원시 팔달구 효원로 1번길', null, null, null);
insert into resident values(124, '황의재', '180315-1234569', '남', '2018-03-15 11:22:00', '병원', '광주광역시 동구 금남로 564번길', null, null, null);
...
# -- 10. members 테이블 데이터 추가
# insert into Members values('admin', '관리자', 'admin');
# insert into Members values('USER', '유저', 'user');
# insert into Members values('guest', '게스트', 'guest');
#
# -- 11. authorities 테이블 데이터 추가
