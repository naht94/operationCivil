...
(
    `resident_serial_number`       integer      not null,
...
(
    ...
    `report_resident_serial_number`    integer     not null,
    ...
    foreign key (`resident_serial_number`) references `resident`
);

CREATE TABLE IF NOT EXISTS `family_relationship`
(
    `base_resident_serial_number`   integer     not null,
    `family_resident_serial_number` integer     not null,
...
(
    `household_serial_number`           integer      not null,
    `household_resident_serial_number`  integer      not null,
...
(
    ...
    foreign key (`household_serial_number`) references `household`
);
